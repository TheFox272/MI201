...
initial_class = 2
target_class = 3 # on transforme les chiens en chats
...
for j in range (9):
    for step in range (3):
        ...
        index_target[index_target==initial_class] = target_class
...
visu = torch.cat([im1,im2,im3,im4,im5,im6,im7,im8,im9],dim=-1).cpu()
